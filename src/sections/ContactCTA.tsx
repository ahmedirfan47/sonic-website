...
export function ContactCTA() {
  ...
  const inputClasses =
    "w-full rounded-lg border border-[var(--color-border-strong)] bg-[var(--color-bg)] px-4 py-2.5 text-sm text-[var(--color-text)] placeholder:text-[var(--color-text-dim)] outline-none transition-colors focus:border-[var(--color-accent)]";
      ...
      <Container className="max-w-2xl">
        ...
        <Reveal delay={140}>
          <p className="mt-4 text-[var(--color-text-muted)]">
            Whether you're evaluating Salesman for your business or exploring
            what Sonic is building next, we read every message.
          </p>
        </Reveal>

        <Reveal delay={200}>
          {sent ? (
            <div className="mt-10 flex items-center gap-3 rounded-2xl border border-[var(--color-accent)]/40 bg-[var(--color-accent-dim)] p-6">
